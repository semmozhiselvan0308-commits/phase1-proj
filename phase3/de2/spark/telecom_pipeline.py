"""
DE3 - Reusable Spark ETL Job

Purpose:
    Run the reusable SP7 Spark ETL job against the DE2 raw zone
    and publish processed and analytics outputs.
"""
...
# Must be configured BEFORE importing PySpark.
os.environ["JAVA_HOME"] = r"C:\Program Files\Java\jdk-17"
os.environ["HADOOP_HOME"] = r"C:\hadoop"
os.environ["hadoop.home.dir"] = r"C:\hadoop"

# Ensure winutils.exe is available
os.environ["PATH"] = (
    r"C:\hadoop\bin;"
    + os.environ.get("PATH", "")
)
...
# None = automatically accept however many matching files exist
...
LOG_FILE = BASE_DIR / "de3_execution.log"
...
logger = logging.getLogger("DE3_SPARK")
...
try:
    ...
    spark = (
        ...
        # Avoid unnecessary Hadoop local filesystem checks
        .config(
    ...
    if len(input_files) == 0:
        ...
        raise FileNotFoundError(
            f"No input files found in {RAW_DIR}"
        )
    ...
    print(
        "PASS: Input discovery completed."
    )
    ...
    missing_columns = [
        ...
        if column_name
        not in standardized_df.columns
    ]
    ...
    print(
        f"Analytics path: {ANALYTICS_DIR}"
    )
    ...
    print(
        "    Blind APPEND can create duplicates."
    )
    ...
    print(
        "    Daily files matching the input pattern"
    )
    ...
    if all_passed:
        ...
        print(
            "DE3 SPARK PROCESSING FAILED - CHECK THE TESTS ABOVE"
        )
